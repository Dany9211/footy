...
def run_auto_backtest(df_source, stake=1.0):
    ...
    Richiede che df_source contenga le colonne quote e gol FT necessarie.
    """
    ...
    market_map = {
        ...
        "Over 0.5 FT": ("Odd_Over_0.5", lambda r: (r["Gol_Home_FT"] + r["Gol_Away_FT"]) > 0.5),
        "Over 1.5 FT": ("Odd_over_1.5", lambda r: (r["Gol_Home_FT"] + r["Gol_Away_FT"]) > 1.5),
        "Over 2.5 FT": ("Odd_over_2.5", lambda r: (r["Gol_Home_FT"] + r["Gol_Away_FT"]) > 2.5),
        "Over 3.5 FT": ("Odd_over_3.5", lambda r: (r["Gol_Home_FT"] + r["Gol_Away_FT"]) > 3.5),
...
st.write("Esegue il backtest su più mercati e strategie in una singola tabella, usando le partite correnti dei filtri.")
